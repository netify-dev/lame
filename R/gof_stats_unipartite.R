...
#' @param Y a square n x n relational data matrix where \code{Y[i,j]} represents the 
...
#'       correlation between \code{Y[i,j]} and \code{Y[j,i]}, capturing reciprocity patterns.}
