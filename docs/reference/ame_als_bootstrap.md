...
uncertainty tool here, mirroring
[`sir::boot_sir()`](https://rdrr.io/pkg/sir/man/boot_sir.html).
...
bootstrap follow the inference scheme of
[`sir::boot_sir()`](https://rdrr.io/pkg/sir/man/boot_sir.html) developed
...
#> intercept    1e-04  0.0222 -0.0391 0.0428
#> 
