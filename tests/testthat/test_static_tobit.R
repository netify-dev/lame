# static tobit (censored normal) models
...
####
# tobit model with covariates + additive + multiplicative effects
####
...
####
# compare models with and without multiplicative effects (tobit)
####
