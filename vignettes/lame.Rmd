...
- **Multiple Data Types**: Support for binary, continuous, ordinal, and count networks
...
- **Comprehensive GOF**: Goodness-of-fit statistics for model assessment
...
- Dorff, C., Minhas, S., et al. (2024). LAME: Longitudinal Analysis of Multilevel Networks. R package.