...
Minhas (the algorithm implemented in `sir::sir_alsfit()` and nicknamed
"ALS" in that package) to the AME model. It is a port and adaptation,
not original lame methodology.
